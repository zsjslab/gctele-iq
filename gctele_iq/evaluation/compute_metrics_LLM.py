...
from gctele_iq.evaluation.eval_prompt.qa import EVAL_PROMPT as QA_PROMPT
from gctele_iq.evaluation.eval_prompt.ac import EVAL_PROMPT as AC_PROMPT
from gctele_iq.evaluation.eval_prompt.cs import EVAL_PROMPT as CS_PROMPT
from gctele_iq.evaluation.eval_prompt.os import EVAL_PROMPT as OS_PROMPT
...
# python -m gctele_iq.evaluation.compute_metrics_LLM --dataset_name A --model qwen2.5-7b-instruct
