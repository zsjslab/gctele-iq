...
# 导入依赖模块
from televal.models import model_mapping
...
#  CUDA_VISIBLE_DEVICES=1,2,3 python -m televal.generation.generator_local --dataset_name A --model qwen2.5-7b-instruct
